...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            {{-- <div class="sidebar-card d-none d-lg-flex">
                ...
                <a class="btn btn-success btn-sm" href="https://google.com">Upgrade to Pro!</a>
            </div> --}}
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; 'Serio' Project 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    @section('serio-js')
        ...
        <script src="{{ asset('vendor/jquery3.6/jquery.min.js') }}"></script>
